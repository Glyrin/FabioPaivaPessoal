...
<head>
    ...
    <title>Portifolio | Trabalhos</title>
...
<body>
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li class="current"><a href="trabalhos.php">Trabalhos</a></li>
    ...
    <div class="container">
            <h1>Selecione a disciplina para ver trabalhos relacionados</h1>
<!--             <form>
                            ...
                            WHERE cod_disc LIKE $cod_disc;";
                                ...
                                if (mysqli_num_rows($resultados) > 0) {
                                    while ($linha = mysqli_fetch_assoc($resultados)) {
                                        ...
                                        echo "</div>";
                                        echo "</div>";
                                        /*                                 echo "Código: " . $linha["CodTrab"] . "<br>Trabalho: " . $linha["NomeTrab"] . "<br>Descrição: " . $linha["DescTrab"];
                                        echo "<br><br>"; */
                                    }
                                } else {
                                    echo "Não existem resultados a apresentar!";
