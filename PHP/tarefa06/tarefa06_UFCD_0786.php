<html>
	...
	<body>
        ...
        <?php 
            $sql_ufcds="SELECT * FROM ufcds WHERE codigo_ufcd=0786;";
        ...
        <div class="texto4">
            ...
            <?php 
            $sql_trabalhos="SELECT t.nome, t.caminho, u.codigo_ufcd FROM trabalhos AS t INNER JOIN ufcds AS u ON t.codigo_ufcd = u.id WHERE U.codigo_ufcd=786;";
